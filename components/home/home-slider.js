      ...
      return (
        <div className="banner" index={slide.id} key={slide.id}>
          <Link href={slide.slide.link ? slide.slide.link : '/about'}>
            <picture>
              <source media="(min-width: 641px)" srcSet={slide.desktop_webp} type="image/webp" />
              <source media="(min-width: 641px)" srcSet={slide.desktop_resized} type="image/png" />
              <source media="(max-width: 640px)" srcSet={slide.slide.mobile_image} type="image/png" />
              <source media="(max-width: 640px)" srcSet={slide.mobile_webp} type="image/webp" />
              <img src={slide.slide.desktop_image} alt={slide.slide.image_alt_text} className="hero-image" />
            </picture>
          </Link>
        </div>
      )
