...
export default function AddToBasketWithDropDown(props) {
  ...
  react.useEffect(() => {
    const varinatNameContainsSPFArray = _.map(
...
const divStyle = {
  ...
  dropdown: {
    ...
    overflowX: "hidden",
    tansition: "all 0.15s linear 0s",
    height: "24px",
    fontSize: "12px",
    cursor: "pointer",
    fontFamily:
      "Apercu Pro, -apple-system, BlinkMacSystemFont, Helvetica, sans-serif",
    appearance: "none",
  },
  spfContainer: {
    display: "flex",
