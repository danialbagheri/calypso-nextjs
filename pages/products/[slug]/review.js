...
import ReviewForm from "../../../components/reviews/ReviewFormWithImageUpload";
import BasicProductInfo from "../../../components/reviews/BasicProductInfo";
...
function Product(props) {
  ...
  const breadCrumbPath = [
    ...
    { name: "Review", url: `/products/${product.slug}/review/` },
  ];
