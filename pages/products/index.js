          ...
          <div className="row">
            ...
            <div className="col-lg-5 col-md-3 col-xs-12 m2">
              ...
              <p className="text-right">
                From scalp protection to insect repellent, we have everything
                you need to{" "}
                <span className="CalypsoOrangeText">stay protected</span> in the
                sun both at home and abroad. Our products are available to buy
                from some of the biggest UK grocery chains as well as some
